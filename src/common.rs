...
const DEFAULT_RUNC_ROOT: &str = "/run/containerd/runh";
const DEFAULT_COMMAND: &str = "runh";
...
pub fn create_runh(
    ...
    gopts
        .build()
        .map_err(other_error!(e, "unable to create runh instance"))
}
